...
---
<!-- trackio-cell
{"type": "code", "id": "cell_51e36b49d355", "created_at": "2026-07-21T07:44:14+00:00", "title": "verify all claims", "command": [".venv/bin/python", "repro/src/verify_auctions.py"], "exit_code": 0, "duration_s": 47.912}
-->
````bash
$ .venv/bin/python repro/src/verify_auctions.py
````

exit 0 · 47.9s


````python title=verify_auctions.py
...
==============================================================================
CLAIM 1 (Theorem 1): allocation a_i is weakly increasing in bid b_i (L2 logistic)
==============================================================================
  sampled 20 users x 20 bid values; monotonicity violations (1->0 transitions): 0 -> PASS

==============================================================================
CLAIM 4 (Corollary 1): individual rationality — payment never exceeds bid
==============================================================================
  max(p_i - b_i) over all users = -0.010981  (must be <= 0) -> PASS
