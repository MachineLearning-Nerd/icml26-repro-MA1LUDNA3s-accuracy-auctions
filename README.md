...
| [`orx/claim-by-claim-evidence-release-candidate`](https://github.com/MachineLearning-Nerd/icml26-repro-MA1LUDNA3s-accuracy-auctions/tree/orx/claim-by-claim-evidence-release-candidate) | Cumulative release regression and additive evidence package | `uv run --frozen python repro/src/verify_auctions.py` | Claims 1–5 PASS; Claim 6 intentionally exits nonzero as BLOCKED | HF CPU, 12m53s |
